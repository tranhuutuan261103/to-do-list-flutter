...
class PythonEditor extends StatefulWidget {
  const PythonEditor({super.key});

  @override
  State<StatefulWidget> createState() => _PythonEditorState();
}

class _PythonEditorState extends State<PythonEditor> {
  final CodeLineEditingController _controller = CodeLineEditingController();

  @override
  void initState() {
    rootBundle.loadString('assets/codes/code.json').then((value) {
