...
final python = Mode(
    refs: {
      '~contains~3~variants~2~contains~3': Mode(
          ...
          keywords: {
            ...
            "built_in":
                "print input len range str int float list dict set tuple open enumerate zip map filter reduce sum max min abs round sorted any all type isinstance issubclass",
    ...
    keywords: {
      "keyword":
          "and elif is global as in if from raise for except finally print import pass return exec else break not with class assert yield try while continue del or lambda async await nonlocal|10",
      "built_in":
          "print input len range str int float list dict set tuple open enumerate zip map filter reduce sum max min abs round sorted any all type isinstance issubclass",
      "literal": "False None True"
    },
    ...
    contains: [
      ...
      Mode(className: "built_in", begin: "\\b(print|input|len|range|str|int|float|list|dict|set|tuple|open|enumerate|zip|map|filter|reduce|sum|max|min|abs|round|sorted|any|all|type|isinstance|issubclass)"),
      Mode(className: "function", beginKeywords: "lambda", end: ":", contains: [
        Mode(self: true),
        Mode(ref: '~contains~0'),
        Mode(ref: '~contains~1'),
        Mode(ref: '~contains~3'),
      ...
      Mode(className: "decorator", begin: "@", end: "\$"),
      Mode(className: "operator", begin: "\\B(\\*\\*|//|\\*\\*|\\*|\\+\\+|\\+|<<|>>|>>|<|>|<=|>=|==|!=|<>|&|\\||\\^|%)"),
    ]);